...
class GammaTest(equivalence.EquivalenceTest, parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ...
      ('entropy broadcasted concentration', (0.5, [0.5, 1., 1.5]), 'entropy'),
      ('entropy broadcasted rate', ([0., 1., -0.5], 0.8), 'entropy'),
      ('mean', ([0., 1., -0.5], [0.5, 1., 1.5]), 'mean'),
      ('mean broadcasted concentration', (0.5, [0.5, 1., 1.5]), 'mean'),
      ('mean broadcasted rate', ([0., 1., -0.5], 0.8), 'mean'),
      ('variance', ([0., 1., -0.5], [0.5, 1., 1.5]), 'variance'),
      ('variance broadcasted concentration', (0.5, [0.5, 1., 1.5]), 'variance'),
      ('variance broadcasted rate', ([0., 1., -0.5], 0.8), 'variance'),
      ('stddev', ([0., 1., -0.5], [0.5, 1., 1.5]), 'stddev'),
      ('stddev broadcasted concentration', (0.5, [0.5, 1., 1.5]), 'stddev'),
      ('stddev broadcasted rate', ([0., 1., -0.5], 0.8), 'stddev'),
      ('mode', ([0., 1., -0.5], [0.5, 1., 1.5]), 'mode'),
      ('mode broadcasted concentration', (0.5, [0.5, 1., 1.5]), 'mode'),
      ('mode broadcasted rate', ([0., 1., -0.5], 0.8), 'mode'),
  )
